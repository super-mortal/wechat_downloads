...
function buildHtmlDocument(o) {
  ...
  return [
    ...
    "<style>",
    "body{font-family:'Noto Serif SC','Noto Serif CJK SC','Source Han Serif SC','Songti SC','STSong','SimSun','宋体','Microsoft YaHei','微软雅黑','PingFang SC','Hiragino Sans GB','WenQuanYi Zen Hei','Droid Sans Fallback',Georgia,serif;font-size:17px;line-height:1.8;color:#1A1A1A;background:#FDFBF7;margin:0;padding:0;}",
